        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="space-y-1">
            <div className="inline-flex items-center gap-1.5 text-xs text-amber-400 font-bold uppercase tracking-wider">
              ...
              <span>Livewire Admissions CRM</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-black text-white">
              Student Lead Management Dashboard
            </h1>
            <p className="text-xs text-slate-400">
              Track, organize, and assign counseling statuses for incoming student applications.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={exportCSV}
              className="bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white px-4 py-2 rounded-xl text-xs font-bold border border-slate-700 transition flex items-center gap-2"
            >
            ...
            <button
              onClick={fetchLeads}
              className="bg-livewire-red hover:bg-livewire-darkRed text-white px-4 py-2 rounded-xl text-xs font-bold transition flex items-center gap-2 shadow-md shadow-red-600/20"
            >
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
          {loading ? (
            ...
            <div className="py-16 text-center text-slate-400 text-xs space-y-2">
              ...
              <p>Try clearing the search query or status filter.</p>
            </div>
          ) : (
